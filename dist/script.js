...
/* harmony import */ var _modules_sliderVertical__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliderVertical */ "./src/js/modules/sliderVertical.js");
...
/* harmony import */ var _modules_pictures__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/pictures */ "./src/js/modules/pictures.js");
/* harmony import */ var _modules_styles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/styles */ "./src/js/modules/styles.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_gift__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_pictures__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_styles__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
function accordion() {
  var accordionHeadings = document.querySelectorAll("#accordion .accordion-heading");
  var accordionBlocks = document.querySelectorAll("#accordion .accordion-block");
...
function calc() {
  ...
  var resultSelector = document.querySelector(".calc-price");
  var sum = 0;
...
function feedbackSlider(time) {
  var slider = document.querySelector(".feedback-slider");
  var nextBtn = document.querySelector(".main-next-btn");
...
function form() {
  ...
  uploads.forEach(function (upload) {
    upload.addEventListener("input", function () {
      var fileName = upload.files[0].name.split('.')[0];
      var fileSecond = upload.files[0].name.split('.')[1];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return gift; });
function gift() {
  var giftItem = document.querySelector(".fixed-gift");
...
function modal(triggerSelector, modalSelector) {
  ...
  function openModal() {
    ...
    document.body.style.overflow = "hidden";
    clearTimeout(_main__WEBPACK_IMPORTED_MODULE_2__["timeout"]);
  }
...
function pictures() {
  var picturesWrapper = document.querySelector(".sizes-wrapper");
  var pictureBlock = picturesWrapper.querySelectorAll(".sizes-block");
  pictureBlock.forEach(function (block) {
    block.addEventListener("mouseover", function (e) {
      var src = block.querySelector("img").getAttribute("src");
...
/***/ "./src/js/modules/sliderVertical.js":
/*!******************************************!*\
  !*** ./src/js/modules/sliderVertical.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return sliderVertical; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);

function sliderVertical(time) {
  var mainSlider = document.querySelector(".main-slider"); // let mainSliderWrapper = document.querySelector(".main-slider-wrapper");

  var mainSliderItems = document.querySelectorAll(".main-slider-item");
  var interval;
  var positionSlide = 0;
...
function styles() {
  var stylesBtn = document.querySelector(".button-styles");
  var allWorks = document.querySelectorAll("#styles .row > div"); // stylesBtn.addEventListener("click", () => {
  ...
  stylesBtn.addEventListener("click", function () {
    getData("assets/db.json").then(function (data) {
      data.styles.forEach(function (obj) {
        var div = document.createElement("div");
        div.classList.add("faded", "col-sm-3", "col-sm-offset-0", "col-xs-10", "col-xs-offset-1");
        div.innerHTML = "\n                    <div class=styles-block>\n\t\t\t\t\t\t<img src=".concat(obj.src, " alt>\n\t\t\t\t\t\t<h4>").concat(obj.title, "</h4>\n\t\t\t\t\t\t<a href=\"").concat(obj.link, "\">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n\t\t\t\t\t</div>");
...
function tabs() {
  ...
  var portfolioMenuItems = document.querySelectorAll(".portfolio-menu li");
  var portfolioWrapper = document.querySelector(".portfolio-wrapper");
  var all = portfolioWrapper.querySelectorAll(".all");
  var noPorfolio = document.querySelector(".portfolio-no"); // all.forEach(picture => {
  ...
  function showPictureByClass(classSelector) {
    if (classSelector == "grandmother" || classSelector == "granddad") {
      ...
      portfolioWrapper.querySelectorAll(".".concat(classSelector)).forEach(function (item) {
  ...
  portfolioMenu.addEventListener("click", function (e) {
    portfolioMenuItems.forEach(function (item, i) {
